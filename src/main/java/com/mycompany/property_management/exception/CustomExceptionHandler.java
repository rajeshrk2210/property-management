...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<List<ErrorModel>> handleFileValidation(MethodArgumentNotValidException many){
    ...
    public ResponseEntity handleBusinessException(BusinessException bex){
        for(ErrorModel em: bex.getErrors()){
            ...
            logger.debug("BusinessException is thrown - level-warn: {} - {}", em.getCode(), em.getMessage());
